...
export default function Login() {
  ...
  const doLogin = () => {
    loginUser(username, password, (ack: any) => {
      if(ack.err) {
        setShowAlert(true);
      ...
      <div className="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
        ...
        <div className="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
          <div className="px-5 py-7">
            ...
            <button onClick={doLogin} type="button" className="dtransition duration-200 bg-blue-500 hover:bg-blue-600 focus:bg-blue-700 focus:shadow-sm focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 text-white w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block">
